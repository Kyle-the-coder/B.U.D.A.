        ...
        <div>
            ...
            <section className="mb-10">
                <div className="flex flex-col md:flex-row items-center sm:items-start w-full h-content justify-center">
                    <img className="rounded infoCard2 m-2" width="600" src={data.summerMainImg} />
            ...
            <section className="mb-5">
                <div className="w-full flex flex-col sm:flex-row items-center sm:items-start justify-evenly">
                    <img className="rounded infoCard hover:drop-shadow-lg mb-5 w-[650px]" src={data.summerImg2} />
                    <img className="rounded infoCard hover:drop-shadow-lg mb-5 w-[650px]" src={data.summerImg3} />
                </div>
            </section>
